...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/diting-server/src/main/java");
        //设置作者名字
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUsername("mallchat");
        dataSourceConfig.setPassword("dFHBw2TAFX6RGnE6");
        dataSourceConfig.setUrl("jdbc:mysql://42.192.202.114:54990/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}