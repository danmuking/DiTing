...
public class UserBackpackCache {
     ...
     * @date 2024/2/5 22:28
     */
    @Cacheable(value = "userBackpack",key = "'itemCount'+#uid+'_'+#itemId")
    public Integer getCountByValidItemId(Long uid, Long itemId) {
        return userBackpackDao.getCountByValidItemId(uid, itemId);
    }
    /**
     * @param uid:
     * @param id:
     * @return void
     * @description 清空物品数量缓存
     * @date 2024/2/6 23:18
     */
    @CacheEvict(value = "userBackpack",key = "'itemCount'+#uid+'_'+#itemId")
    public void InvalidCountByValidItemId(Long uid, Long id) {
        return;
    }
}
